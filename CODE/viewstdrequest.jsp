...
<html>
    ...
    //      out.print("College : "+cid);
            ...
            rs=st.executeQuery("select * from request where cid='"+cid+"'");  
    %>
      <div style="position: absolute; width: 723px; height: 100px; z-index: 5; left: 35px; top: 100px" id="layer9">
            <table border="2" width="100%" bordercolor="#808080" id="table1">
                    <tr>
                            <td align="center"><b><font face="Verdana" size="2" color="#E4DB6B"><%=college%>College</font></b></td>
                            <td align="center"><b><font face="Verdana" size="2" color="#E4DB6B">Student</font></b></td>
                            <td align="center" width="218"><b><font face="Verdana" size="2" color="#E4DB6B">Request For</font></b></td>
                            <td align="center" width="121"><b><font face="Verdana" size="2" color="#E4DB6B">Requested Date</font></b></td>
                            <td align="center"><b><font face="Verdana" size="2" color="#E4DB6B">Response</font></b></td>
                            <td align="center"><b><font face="Verdana" size="2" color="#E4DB6B">Response Date</font></b></td>
                    </tr>
    <%
            while(rs.next())
            {
     ...
     %>
                                ...
                                <tr>
                                        ...
                                        <td align="center" width="218"><b><font face="Verdana" size="2" color="black"><%=resp%></font></b></td>
                                        <td align="center" width="218"><b><font face="Verdana" size="2" color="black"><%=respdate%></font></b></td>
                                </tr>
