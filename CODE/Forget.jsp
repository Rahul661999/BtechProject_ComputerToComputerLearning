...
<body>
	...
	<%
		...
		ResultSet rs=stmt.executeQuery("select password,firstname from student where email='"+to+"'");
		if(rs.next())
		{
			String s="Your password is  "+rs.getString(1)+"  and firstname= "+rs.getString(2)+" please Update your password.";
